...
export class BattleScene extends Phaser.Scene {
  ...
  create() {
    ...
    reg("dioupe-attack-right",  "dioupe-attack-right",  4, 7, false)
    reg("dioupe-attack-left",   "dioupe-attack-left",   4, 7, false)
    ...
    reg("bw-attack-right",  "bw-attack-right",  7, 7,  false)
    reg("bw-attack-left",   "bw-attack-left",   7, 7,  false)
